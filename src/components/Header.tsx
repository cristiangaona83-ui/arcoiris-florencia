...
export function Header() {
  ...
  // Cierra el menú móvil si la pantalla pasa a tamaño escritorio mientras está abierto,
  // evitando que el bloqueo de scroll del body quede activo por error.
  useEffect(() => {
    const onResize = () => {
      ...
      >
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:h-20 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              className="inline-flex h-11 w-11 touch-manipulation items-center justify-center rounded-full bg-white text-ink shadow-card lg:hidden"
